...
public class TesterSesion {
	...
	public static void main(String[] args) {
		...
		/*
		 * Intentamos crear 4 sesiones para esa pelicula. Aqui comprobamos que no se
		 * pueden solapar sesiones (s2 se solaparia a s1)
		 */
		...
		/*
		 * Imprimimos las sesiones que se han creado
		 */
		...
		/*
		 * Actualizamos las butacas vendidas, es decir, simulamos que se vende una, y
		 * como la sala la hemos creado con una sola butaca comprobamos que devuelve
		 * true
		 */
		...
		/*
		 * Actualizamos las butacas vendidas, es decir, simulamos que se vende otra, y
		 * como la sala la hemos creado con una sola butaca y ya hemos disminuido las
		 * butacas disponibles comprobamos que devuelve false
		 */
		check = s1.actualizarButacasVendidas();
		if (!check) {
			System.out.println("No hay más butacas.\n");
