...
/**
 * Esta clase extiende la clase Entrada, con la diferencia de que tiene un atributo de un descuento, por
 * lo que el precio se calcula de manera diferente
...
public class EntradaDiaEspectador extends Entrada {
	...
	/**
	 * Descuento aplicado si la entrada es del dia del espectador. Es estatico, pues es
	 * el mismo para todas las entradas
	 */
	 ...
	 * @param descuento_ Nuevo descuento para las entradas del dia del espectador
	 */
	...
	@Override
	/**
	 * Metodo toString de la clase EntradaDiaEspectador. Necesario para imprimir por pantalla una entrada en formato legible
