...
/**
 * Esta clase Pelicula almacena todos los datos necesarios de una pelicula. Es
 * una clase bastante simple, puesto que no hace llamadas a otras clases,
 * exceptuando la enumeracion de Genero
 * 
...
public class Pelicula {
	 ...
	 * 
	 * @param titulo
	 *            Titulo deseado de la pelicula
	 * @param director
	 *            Nombre del director de la pelicula
	 * @param anno
	 *            Anno de grabacion de la pelicula
	 * @param sinopsis
	 *            Sinopsis de la pelicula
	 * @param genero
	...
	@Override
	/**
	 * Metodo toString de la clase Pelicula. Necesario para imprimir por pantalla
	 * una pelicula en formato legible
	 * 
