...
/**
 * Clase Sesion. Almacena los datos identificativos de una sesion (fehca,
 * pelicula), así como un contador de las butacas disponibles. Hace llamadas a
 * metodos de las clases Pelicula y Sala, puesto que tiene atributos de dichas
 * clases
 * 
...
public class Sesion {
	 ...
	 * 
	 * @param anyo
	 *            Anno de inicio de la proyeccion
	 * @param mes
	 *            Mes de inicio de la proyeccion
	 * @param dia
	 *            Dia de inicio de la proyeccion
	 * @param hora
	 *            Hora de inicio de la proyeccion
	 * @param minuto
	 *            Minuto de inicio de la proyeccion
	 * @param pelicula
	 *            Pelicula a proyectar
	 * @param sala
	 *            Sala en la que se desarrolla la sesion
	 */
	public Sesion(Integer anyo, Integer mes, Integer dia, Integer hora, Integer minuto, Pelicula pelicula, Sala sala) {
		...
		switch (mes) {
		case 1:
			this.fecha.set(Calendar.MONTH, Calendar.JANUARY);
			break;
		case 2:
			this.fecha.set(Calendar.MONTH, Calendar.FEBRUARY);
			break;
		case 3:
			this.fecha.set(Calendar.MONTH, Calendar.MARCH);
			break;
		case 4:
			this.fecha.set(Calendar.MONTH, Calendar.APRIL);
			break;
		case 5:
			this.fecha.set(Calendar.MONTH, Calendar.MAY);
			break;
		case 6:
			this.fecha.set(Calendar.MONTH, Calendar.JUNE);
			break;
		case 7:
			this.fecha.set(Calendar.MONTH, Calendar.JULY);
			break;
		case 8:
			this.fecha.set(Calendar.MONTH, Calendar.AUGUST);
			break;
		case 9:
			this.fecha.set(Calendar.MONTH, Calendar.SEPTEMBER);
			break;
		case 10:
			this.fecha.set(Calendar.MONTH, Calendar.OCTOBER);
			break;
		case 11:
			this.fecha.set(Calendar.MONTH, Calendar.NOVEMBER);
			break;
		case 12:
			this.fecha.set(Calendar.MONTH, Calendar.DECEMBER);
			break;
		default:
			this.sala = null;
			return;
	 ...
	 *            Nueva cantidad de butacas disponibles de la sesion
	 */
	...
	/**
	 * Metodo que calcula el momento de finalizacion de la sesion Utilizado para que
	 * no pueda haber en una misma sala dos sesiones solapandose, es decir, que una
	 * empiece antes de que termine la otra
	 * 
	...
	/**
	 * Metodo que actualiza el numero de butacas disponibles para la sala. Se
	 * comprueba si se puede vender una entrada, o si ya estan agotadas
	 * 
	 * @return Valor booleano
	 *         <ul>
	 *         <li>True si se ha podido decrementar el numero de butacas
	 *         disponibles</li>
	...
	@Override
	/**
	 * Metodo toString de la clase Sesion. Necesario para imprimir por pantalla los
	 * datos de una sesion en formato legible
	 * 
