...
/**
 * Clase que almacena los datos de una entrada. Hace llamadas a los metodos de
 * la clase Sesion, puesto que tiene un atributo de esa clase
 * 
...
public class Entrada {
	/**
	 * Atributo de clase usado para contar cuantas entradas se han creado hasta el
	 * momento y poder generar un identificador unico para cada una
	 */
	...
	/**
	 * Atributo de clase del precio, al ser constante para todas las entradas (sin
	 * tener en cuenta el descuento del dia del espectador)
	 */
	 ...
	 * 
	 * @param sesion
	 *            Sesion para la cual es la entrada
	 */
	 ...
	 * 
	 * @param precio
	 *            Nuevo precio para las entradas
	 */
	 ...
	 * 
	 * @param identificador
	 *            Nuevo identificador de la entrada
	 */
	...
	@Override
	/**
	 * Metodo toString de la clase Entrada. Necesario para imprimir por pantalla una
	 * entrada en formato legible
	 * 
